...
- **Versioned content** — documents persist as versioned ProseMirror JSON (`DocumentJSON`).
...
│   ├── hooks/         # useDocumentEditor, useFeatureState, useToolbar
│   ├── components/    # DocumentEditor, EditorToolbar, BubbleToolbar, InsertToolbar
