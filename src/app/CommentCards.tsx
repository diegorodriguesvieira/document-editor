...
export function CommentCards({ editor }: { editor: Editor | null }) {
  ...
  // No comments → no panel at all. The rail stays clean until there is
  // something to review; the panel reappears reactively with the first anchor
  // (and leaves again when the last one is deleted).
