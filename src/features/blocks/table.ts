          ...
          items: [
            {
              ...
              icon: "↑",
              commandId: "table.addRowBefore",
            },
            {
              id: "row-below",
              label: "Insert row below",
              icon: "↓",
              commandId: "table.addRowAfter",
            },
            {
              id: "row-delete",
              label: "Delete row",
              icon: "🗑",
              commandId: "table.deleteRow",
              danger: true,
            },
          ],
        },
          ...
          items: [
            {
              ...
              icon: "←",
              commandId: "table.addColumnBefore",
            },
            {
              id: "col-right",
              label: "Insert column right",
              icon: "→",
              commandId: "table.addColumnAfter",
            },
            {
              id: "col-delete",
              label: "Delete column",
              icon: "🗑",
              commandId: "table.deleteColumn",
              danger: true,
            },
          ],
        },
          ...
          items: [
            {
              ...
              label: "Merge cells",
              icon: "⧉",
              commandId: "table.mergeCells",
            },
            {
              id: "split",
              label: "Split cell",
              icon: "⊟",
              commandId: "table.splitCell",
            },
            {
              id: "header",
              label: "Toggle header row",
              icon: "▦",
              commandId: "table.toggleHeaderRow",
            },
          ],
        },
        {
